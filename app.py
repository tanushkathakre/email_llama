...
def find_similar_offense(input_offense):
    ...
    for offense in data['Offense']:
        ...
        similarity = max([wn.wup_similarity(wn.synsets(input_offense)[0], wn.synsets(offense)[0]) or 0 
                          for syn1 in wn.synsets(input_offense) for syn2 in wn.synsets(offense)])
